...
struct SumDistance2 {
	...
	bool first;
	SumDistance2(TGraph2D *g, std::vector<double> weight) : fGraph(g), fWeight(weight) {first=true;}
...
struct SumPlaneDistance2 {
	...
	std::vector<double> fWeight;
	bool first;
	SumPlaneDistance2(TGraph2D *g, std::vector<double> weight) : fGraph(g), fWeight(weight) {first=true;}
